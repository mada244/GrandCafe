...
public partial class JuiceCategory : ContentPage
{
    ...
    async void OnTextChanged(object sender, EventArgs e)
    {
        ...
        var filtered = products.Where(p => p.Category == "Juice");
    ...
    private async Task LoadProductsAsync()
    {
        ...
        var drinks = allProducts.Where(p => p.Category == "Juice");
        Products.Clear();
